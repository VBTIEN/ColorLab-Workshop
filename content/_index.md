...
|-------|-------|----------|-------|
| **I** | [Foundation Setup](1-foundation-setup/) | 60 min | AWS Account, Security, Environment |
| **II** | [Core Services](2-core-services/) | 90 min | Lambda Functions, Algorithms |
| **III** | [API & Networking](3-api-networking/) | 60 min | API Gateway, CORS, Testing |
| **IV** | [Storage & Web](4-storage-web/) | 45 min | S3 Hosting, Web Interface |
| **V** | [Security & Monitoring](5-security-monitoring/) | 45 min | IAM, CloudWatch, Best Practices |
| **VI** | [Production & Optimization](6-production-optimization/) | 60 min | Performance, Cost, Deployment |
...
![ColorLab Architecture Diagram](https://vbtien.github.io/ColorLab-Workshop/images/architecture-diagram.jpg)
...
{{% notice tip %}}
**Ready to begin?** Start with [Phase I - Foundation Setup](1-foundation-setup/) to prepare your AWS environment and development tools.
{{% /notice %}}
...
[**Begin with Phase I - Foundation Setup →**](1-foundation-setup/)
